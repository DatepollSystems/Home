...
1.  Now execute this command **and fill in your own domain**
    ```
    sudo certbot certonly --standalone --preferred-challenges http -d datepoll.server.com --pre-hook="systemctl stop nginx" --post-hook="systemctl start nginx"
    ```
---
...
1.  First go into your sites-enabled folder. 
    ...
    ```
1.  Next paste this config into your editor **and fill in your own domain and path to your DatePoll docker installation**
   ```
   server {
     listen 80;
     # Change domain
